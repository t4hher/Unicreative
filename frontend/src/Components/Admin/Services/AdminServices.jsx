                    ...
                    <tbody>
                        {services.map((service)=>
                            <tr key={service.id}>
                                ...
                                <td>{service.image2===null ? <img src="https://t4.ftcdn.net/jpg/04/70/29/97/360_F_470299797_UD0eoVMMSUbHCcNJCdv2t8B2g1GVqYgs.jpg" width={50}/> : <img src={`http://127.0.0.1:8000/storage/${service.image2}`} width={70}/>}</td>
                                <td>
